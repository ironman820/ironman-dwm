...
/* tagging */
static const char *tags[]    = { "", "", "󱚾", "4", "5", "6", "", "󰏲", "" };
...
static const Rule rules[] = {
  ...
  { "explorer.exe",    NULL,     "Default - Wine desktop", 0,         1,          -1 },
  { "firefox",         NULL,     NULL,                     1 << 1,    0,          -1 },
  { "gloCOM",          "gloCOM", NULL,                     1 << 7,    0,          -1 },
  { "TelegramDesktop", NULL,     NULL,                     1 << 6,    0,          -1 },
  { "winbox.exe",      NULL,     NULL,                     1 << 2,    0,          -1 },
};
...
static const char *extmoncmd[]  = { "~/.local/share/dwm/display.sh", "-d", NULL };
static char dmenumon[2]         = "0"; /* component of dmenucmd,     manipulated in spawn() */
static const char *dmenucmd[]   = { "dmenu_run",                     "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, NULL };
static const char *intmoncmd[]  = { "~/.local/share/dwm/display.sh", "-p", NULL };
...
static const Key keys[] = {
  ...
  TAGKEYS(XK_8,         7)
  TAGKEYS(XK_9,         8)
  { MODKEY|ControlMask, XK_q,      exitdwm,        {0} },
};
